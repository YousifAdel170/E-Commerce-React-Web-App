...
const AdminCategoryCard = ({ category }) => {
  ...
  return (
    <div className="user-address-card my-3 px-2">
      ...
      <Row className="d-flex justify-content-between pt-2">
        <Col xs="6">
          <div className="p-2 fw-bold">
            اسم التصنيف: <span className="fw-normal me-2">{category.name}</span>
          </div>
        </Col>
      ...
      <Row>
        <Col xs="12" className="d-flex pb-3 justify-content-between">
          ...
          {/* Button to get the subcategories */}
          <button className="btn btn-dark mx-2 align-self-end">
            <Link
